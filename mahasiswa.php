...
echo "<br>";
echo "Mata kuliah: ";echo $obj->mata_kuliah[3];
echo "<br>";
echo "Mata kuliah: ";echo $obj->mata_kuliah[4];
echo "<br>";
echo "Mata kuliah: ";echo $obj->mata_kuliah[5];
echo "<br>";
echo "Mata kuliah: ";echo $obj->mata_kuliah[6];
echo "<br>";
echo "Mata kuliah: ";echo $obj->mata_kuliah[7];
echo "<br>";
?>